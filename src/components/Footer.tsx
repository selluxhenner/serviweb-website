...
<<<<<<< HEAD
              ...
              <img src="/logo-large-white.png" alt="Serviweb" className="h-4 w-auto" />
            </Link>
...
=======
              ...
              <span className="text-lg font-bold tracking-tight text-white">
                Servi<span className="text-blue-400">Web</span>
              </span>
            </Link>
...
=======
            <p className="text-xs font-semibold tracking-widest text-slate-500 uppercase mb-5">Navigation</p>
>>>>>>> 86a17aa693b6f0eba0f19f692bd96f1fb586f8f2
...
=======
            <p className="text-xs font-semibold tracking-widest text-slate-500 uppercase mb-5">Regionen</p>
>>>>>>> 86a17aa693b6f0eba0f19f692bd96f1fb586f8f2
            <ul className="space-y-3" role="list">
              {REGION_LINKS.map((l) => (
                <li key={l.label}>
...
=======
            <p className="text-xs font-semibold tracking-widest text-slate-500 uppercase mb-5">Kontakt</p>
            <ul className="space-y-3" role="list">
              <li className="flex items-start gap-2.5 text-sm text-slate-400">
                <svg className="w-4 h-4 text-blue-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
>>>>>>> 86a17aa693b6f0eba0f19f692bd96f1fb586f8f2
...
=======
                  className="flex items-center gap-2.5 text-sm text-slate-400 hover:text-white transition-colors duration-200 cursor-pointer"
                >
...
=======
          className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-600"
          style={{ borderTop: '1px solid rgba(59,130,246,0.08)' }}
        >
          <p>© {new Date().getFullYear()} Serviweb · Kevin Schmid. Alle Rechte vorbehalten.</p>
          <div className="flex items-center gap-5">
            <Link to="/impressum" className="hover:text-slate-400 transition-colors cursor-pointer">Impressum</Link>
            <Link to="/datenschutz" className="hover:text-slate-400 transition-colors cursor-pointer">Datenschutz</Link>
>>>>>>> 86a17aa693b6f0eba0f19f692bd96f1fb586f8f2
          </div>
        </div>
      </div>

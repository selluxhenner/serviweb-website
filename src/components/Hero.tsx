...
<<<<<<< HEAD
    ...
    >
      <div className="w-11 h-11 rounded-xl flex items-center justify-center mb-5"
        style={{ background: 'rgba(37,99,235,0.1)' }} aria-hidden="true">{p.icon}</div>
      <h2 className="text-base font-bold mb-2" style={{ color: '#1E3A8A' }}>{p.title}</h2>
        ...
        >
          ...
          <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
            <motion.div className="absolute top-[-200px] left-[-150px]" style={{ x: o1x, y: o1y }}>
              <div className="rounded-full pointer-events-none" style={{ width:700, height:700, filter:'blur(100px)',
...
<<<<<<< HEAD
                ...
                />
                <FeatureCard
                  icon={<svg className="w-6 h-6" style={{ color: '#2563EB' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>}

          ...
          >
              ...
              <motion.div variants={navItem}>
                <Link to="/leistungen" onClick={closeAll}
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    {isActive('/leistungen') && (
                      <span className="text-[10px] text-blue-600 font-semibold px-2 py-0.5 rounded-full"
                        style={{ background: 'rgba(37,99,235,0.1)' }}>aktiv</span>
                    )}
                  </div>
            ...
            <motion.div
              ...
              <div className="flex items-center gap-2.5 mb-4">
                ...
                <span className="text-sm font-medium text-emerald-600">Aktuell verfügbar</span>
                <span className="text-xs text-slate-500">· Antwort in 24h</span>
              </div>
              <Link to="/kontakt" onClick={closeAll}
